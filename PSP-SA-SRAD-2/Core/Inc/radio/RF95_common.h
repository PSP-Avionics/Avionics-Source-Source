...
#ifndef INC_RADIO_RF95_COMMON_H_
#define INC_RADIO_RF95_COMMON_H_
...
#define FRF_SCALAR2 1.0f
#define FRF_SCALAR 999428.001369688f
#define calc_frf(freq_mhz_float) (uint32_t)((FRF_SCALAR * freq_mhz_float)) / (uint32_t)RH_RF95_FSTEP
...
#endif /* INC_RADIO_RF95_COMMON_H_ */
